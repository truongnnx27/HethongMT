type TProducts = { id: number; ten_sp: string; image: string; gia: number };
type TTUser = { id: number; fullname: string; password: string; email: string,phai:TGioitinh };
type TGioitinh = string | boolean;
type TCoso = { id: number; ten: string; diachi: string; hinh: string };
type TTSPthuocCS = TProducts & TCoso;
...
export{TCoso, TGioitinh,TProducts,TTUser}
